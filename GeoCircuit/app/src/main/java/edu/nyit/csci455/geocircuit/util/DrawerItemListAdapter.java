...
public class DrawerItemListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView image = (ImageView) view.findViewById(R.id.item_drawer_image);
        TextView title = (TextView) view.findViewById(R.id.item_drawer_text);

        switch (position) {
            case 0:
                image.setImageResource(R.drawable.ic_dashboard);
                title.setText(R.string.action_dashboard);
                break;
